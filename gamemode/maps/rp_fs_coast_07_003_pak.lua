...
SpawnHeliA( Vector(2651.069580, 92.824120, 2409.736816), "npc_combinegunship" )
...
--creating:Give("ai_weapon_ar2")
--creating:SetName("Combine")
--creating:SetCurrentWeaponProficiency( WEAPON_PROFICIENCY_PERFECT )
-- creating:Fire("SetTrack","path",4)
-- creating:Fire("SetTrack","path2",12)
-- creating:Fire("SetTrack","path3",18)
--HeliA:Fire("StartBreakableMovement","",2)
-- 



local sprite = ents.Create( "env_sprite" )
sprite:SetPos( Vector(3040.227783, -4888.031250, 1893.531250) )

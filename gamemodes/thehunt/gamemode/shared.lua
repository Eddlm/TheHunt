...
function CalculatePlayerScore(ply)
	...
	if ply.deaths==0 then 
		ply:SetNWInt("Survivor", 1) 
	else 
		ply:SetNWInt("Survivor", 0) 
	end
...
local GlobalRemaining = GetConVarNumber("h_combine_killed_to_win")-COMBINE_KILLED
    ...
    if text == "!remain" or text == "!REMAIN" then
		...
		timer.Simple(3, function() 
			PrintMessage(HUD_PRINTTALK, "[Overwatch]: Mission failure if "..GlobalRemaining.." ground units are lost.") 
		end)
		return false
	end
...
-- Weapons mix
STALKER_SWEPS ={"stalker_deagle", "stalker_ak74_u", "stalker_usp", "stalker_p220", "stalker_baretta_dual", "stalker_dragunov", "stalker_ak74", "stalker_p99", "stalker_gauss", "stalker_eliminator", "stalker_pkm", "stalker_ots", "stalker_lr300", "stalker_rpg", "stalker_f2000", "stalker_winchester", "stalker_sg550", "stalker_abaton", "stalker_vintorez", "stalker_baretta_single", "stalker_makarov", "stalker_val", "stalker_spas", "stalker_svu", "stalker_knife", "stalker_enfield", "stalker_fort_12", "stalker_colt", "stalker_mp5", "stalker_bulldog", "stalker_g36", "stalker_pb", "stalker_browning"}
